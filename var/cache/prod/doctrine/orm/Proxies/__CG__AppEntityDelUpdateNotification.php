 ...
 */
class DelUpdateNotification extends \App\Entity\DelUpdateNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\DelUpdateNotification' . "\0" . 'id', '' . "\0" . 'App\\Entity\\DelUpdateNotification' . "\0" . 'identiplanteScore', '' . "\0" . 'App\\Entity\\DelUpdateNotification' . "\0" . 'isIdentiplanteValidated', '' . "\0" . 'App\\Entity\\DelUpdateNotification' . "\0" . 'dateUpdated', '' . "\0" . 'App\\Entity\\DelUpdateNotification' . "\0" . 'occurrence'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DelUpdateNotification $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setIdentiplanteScore(?int $identiplanteScore): \App\Entity\DelUpdateNotification
    {
     ...
     * {@inheritDoc}
     */
    public function setIsIdentiplanteValidated($isIdentiplanteValidated): \App\Entity\DelUpdateNotification
    {
     ...
     * {@inheritDoc}
     */
    public function setDateUpdated(?\DateTimeInterface $dateUpdated): \App\Entity\DelUpdateNotification
    {
     ...
     * {@inheritDoc}
     */
    public function setOccurrence(?\App\Entity\Occurrence $occurrence): \App\Entity\DelUpdateNotification
    {
