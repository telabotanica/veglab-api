...
// Returns the private 'App\Filter\Photo\TagFilter' shared autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Filter/Photo/TagFilter.php';

return $this->privates['App\\Filter\\Photo\\TagFilter'] = new \App\Filter\Photo\TagFilter();
