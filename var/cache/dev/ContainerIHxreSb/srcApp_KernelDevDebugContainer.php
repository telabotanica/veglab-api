...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5BU8Yh2JXG', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Q1GU-WZqgF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventListener([0 => 'prePersist'], 'app.event.listener.occurrence.event.listener');
        $d->addEventListener([0 => 'preUpdate'], 'app.event.listener.occurrence.event.listener');
        $d->addEventListener([0 => 'preRemove'], 'app.event.listener.occurrence.event.listener');
        $d->addEventListener([0 => 'prePersist'], 'app.event.listener.photo.event.listener');
        $d->addEventListener([0 => 'postPersist'], 'app.event.listener.photo.event.listener');
        $d->addEventListener([0 => 'prePersist'], 'app.event.listener.pdf.file.event.listener');
        $d->addEventListener([0 => 'prePersist'], 'app.event.listener.owned.entity.event.listener');
        $d->addEventListener([0 => 'prePersist'], 'app.event.listener.timestamped.entity.event.listener');
        $d->addEventListener([0 => 'preUpdate'], 'app.event.listener.timestamped.entity.event.listener');
        $d->addEventListener([0 => 'postPersist'], 'app.event.listener.photo.photo.tag.relation.event.listener');
        $d->addEventListener([0 => 'postRemove'], 'app.event.listener.photo.photo.tag.relation.event.listener');
        $d->addEventListener([0 => 'postPersist'], 'app.event.listener.occurrence.user.occurrence.tag.relation.event.listener');
        $d->addEventListener([0 => 'postRemove'], 'app.event.listener.occurrence.user.occurrence.tag.relation.event.listener');
        $d->addEventListener([0 => 'loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners');
        $d->addEventListener([0 => 'postPersist'], 'fos_elastica.listener.occurrences.occurrence');
        $d->addEventListener([0 => 'postUpdate'], 'fos_elastica.listener.occurrences.occurrence');
        $d->addEventListener([0 => 'preRemove'], 'fos_elastica.listener.occurrences.occurrence');
        $d->addEventListener([0 => 'postFlush'], 'fos_elastica.listener.occurrences.occurrence');
        $d->addEventListener([0 => 'postPersist'], 'fos_elastica.listener.photos.photo');
        $d->addEventListener([0 => 'postUpdate'], 'fos_elastica.listener.photos.photo');
        $d->addEventListener([0 => 'preRemove'], 'fos_elastica.listener.photos.photo');
        $d->addEventListener([0 => 'postFlush'], 'fos_elastica.listener.photos.photo');
        $d->addEventListener([0 => 'postPersist'], 'fos_elastica.listener.tables.table');
        $d->addEventListener([0 => 'postUpdate'], 'fos_elastica.listener.tables.table');
        $d->addEventListener([0 => 'preRemove'], 'fos_elastica.listener.tables.table');
        $d->addEventListener([0 => 'postFlush'], 'fos_elastica.listener.tables.table');
        $d->addEventListener([0 => 'postPersist'], 'fos_elastica.listener.observers.observer');
        $d->addEventListener([0 => 'postUpdate'], 'fos_elastica.listener.observers.observer');
        $d->addEventListener([0 => 'preRemove'], 'fos_elastica.listener.observers.observer');
        $d->addEventListener([0 => 'postFlush'], 'fos_elastica.listener.observers.observer');
        $d->addEventListener([0 => 'postPersist'], 'fos_elastica.listener.biblio_phytos.biblio_phyto');
        $d->addEventListener([0 => 'postUpdate'], 'fos_elastica.listener.biblio_phytos.biblio_phyto');
        $d->addEventListener([0 => 'preRemove'], 'fos_elastica.listener.biblio_phytos.biblio_phyto');
        $d->addEventListener([0 => 'postFlush'], 'fos_elastica.listener.biblio_phytos.biblio_phyto');
    ...
    {
        $this->services['fos_elastica.client.default'] = $instance = new \FOS\ElasticaBundle\Elastica\Client(['connections' => [0 => ['host' => $this->getEnv('FOS_ELASTICA_CLIENTS_DEFAULT_HOST'), 'port' => $this->getEnv('FOS_ELASTICA_CLIENTS_DEFAULT_PORT'), 'http_error_codes' => [0 => 400, 1 => 403, 2 => 404], 'ssl' => false, 'logger' => 'fos_elastica.logger', 'compression' => false, 'headers' => [], 'curl' => [], 'retryOnConflict' => 0, 'persistent' => true]], 'connectionStrategy' => 'Simple'], '');
    ...
    protected function getSerializerService()
    {
        ...
        $i = new \ApiPlatform\Core\Serializer\ItemNormalizer($a, $b, $c, $d, $e, $f, $g, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
        ...
        $p = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($g, $f, $e, ($this->privates['property_info'] ?? $this->getPropertyInfoService()), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($g), NULL, []);

        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \App\Serializer\GeoJsonOccurrenceNormalizer($i), 1 => new \App\Serializer\JsonPatchOccurrenceNormalizer($i), 2 => new \App\Serializer\PdfOccurrenceNormalizer($i), 3 => $m, 4 => new \ApiPlatform\Core\JsonApi\Serializer\ConstraintViolationListNormalizer($b, $n), 5 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($j, [], $f), 6 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $f), 7 => $m, 8 => new \ApiPlatform\Core\JsonApi\Serializer\ErrorNormalizer(true), 9 => new \ApiPlatform\Core\JsonApi\Serializer\EntrypointNormalizer($h, $c, $j), 10 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($h, $a, $b, $d, NULL, $j, $k, $f), 11 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($h, $c, $j), 12 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($j, true), 13 => new \ApiPlatform\Core\Hal\Serializer\EntrypointNormalizer($h, $c, $j), 14 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 15 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 16 => new \ApiPlatform\Core\JsonApi\Serializer\ItemNormalizer($a, $b, $c, $d, $e, $n, $h, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vaXTRmc0NZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('K3L0cWIdhB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cODBtireMG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TVTsput87J', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZF3zHQ89Sb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2OpUDTB8p6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0BgaeDq1ao', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZUIQOFT-eO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\BaseVoter'] ?? $this->load('getBaseVoterService.php'));
            yield 4 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\ExtendedFieldOccurrenceVoter'] ?? $this->load('getExtendedFieldOccurrenceVoterService.php'));
            yield 5 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\OccurrenceUserOccurrenceTagRelationVoter'] ?? $this->load('getOccurrenceUserOccurrenceTagRelationVoterService.php'));
            yield 6 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\OccurrenceVoter'] ?? $this->load('getOccurrenceVoterService.php'));
            yield 7 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\PhotoPhotoTagRelationVoter'] ?? $this->load('getPhotoPhotoTagRelationVoterService.php'));
            yield 8 => ($this->privates['debug.security.voter.App\\Security\\Authorization\\PhotoVoter'] ?? $this->load('getPhotoVoterService.php'));
            yield 9 => ($this->privates['debug.security.voter.security.acccess.occurrence_voter'] ?? $this->load('getDebug_Security_Voter_Security_Acccess_OccurrenceVoterService.php'));
            yield 10 => ($this->privates['debug.security.voter.security.acccess.photo_voter'] ?? $this->load('getDebug_Security_Voter_Security_Acccess_PhotoVoterService.php'));
            yield 11 => ($this->privates['debug.security.voter.security.acccess.extended_field_occurrence_voter'] ?? $this->load('getDebug_Security_Voter_Security_Acccess_ExtendedFieldOccurrenceVoterService.php'));
            yield 12 => ($this->privates['debug.security.voter.security.acccess.occurrence_user_occurrence_tag_relation_voter'] ?? $this->load('getDebug_Security_Voter_Security_Acccess_OccurrenceUserOccurrenceTagRelationVoterService.php'));
            yield 13 => ($this->privates['debug.security.voter.security.acccess.photo_photo_tag_relation_voter'] ?? $this->load('getDebug_Security_Voter_Security_Acccess_PhotoPhotoTagRelationVoterService.php'));
            yield 14 => ($this->privates['debug.security.voter.security.access.base_voter'] ?? $this->load('getDebug_Security_Voter_Security_Access_BaseVoterService.php'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'locale' => 'fr',
            'auth' => [
                'serverHost' => 'www.tela-botanica.org',
                'serverProtocol' => 'https',
                'serverPort' => '80',
                'serverBasePath' => 'service:annuaire:auth',
            ],
