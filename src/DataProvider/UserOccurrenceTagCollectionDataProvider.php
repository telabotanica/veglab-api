...
/**
 * A data provider for collections of <code>UserOccurrenceTag</code> instances 
 * which must be filtered based on the current user.
 *
 * @package App\DataProvider
 */
class UserOccurrenceTagCollectionDataProvider 
    ...
    public function supports(
        ...
        return UserOccurrenceTag::class === $resourceClass;
    }
    ...
    public function getCollection(
        ...
        $repository = $entityManager->getRepository(UserOccurrenceTag::class);
